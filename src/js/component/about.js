      ...
      <div className="row m-5">
        ...
        <div className="col-12 timeline">
          ...
          <div className="timeline-content">
            ...
            <p className="timeline-description">
              Mastering the art of quality assurance means delving deep into the
              core of software integrity. My approach to QA engineering combines
              meticulous attention to detail with a relentless pursuit of
              excellence, ensuring every application not only meets but exceeds
              rigorous standards. By applying comprehensive testing strategies
              and innovative problem-solving techniques, I uncover hidden issues
              and optimize performance, delivering flawless user experiences.
              Explore my QA projects to see how my expertise transforms
              potential into perfection.
            </p>
          </div>
          <div className="timeline-content">
            ...
            <p className="timeline-description">
              In the ever-evolving landscape of education, EdTech stands at the
              forefront of innovation, revolutionizing how we teach and learn.
              By seamlessly integrating cutting-edge technology with pedagogical
              expertise, I create solutions that transform traditional
              classrooms into dynamic, interactive learning environments. My
              approach combines intuitive design with robust functionality,
              ensuring that educational tools not only engage students but also
              empower educators. Discover how my passion for educational
              technology bridges the gap between knowledge and application,
              driving both academic success and lifelong learning.
            </p>
          </div>
          ...
          <div className="timeline-content">
            ...
            <p className="timeline-description">
              ...
              Fullstack Development program that shaped my journey from a novice
              to a proficient developer. This rigorous curriculum blended
              cutting-edge technologies with hands-on projects, empowering me to
              master both front-end and back-end development. Through real-world
              coding challenges and collaborative teamwork, I honed my skills in
              React, Python, and more, building robust applications from the
              ground up. This transformative experience not only deepened my
              technical expertise but also ignited my passion for crafting
              innovative, scalable solutions in the ever-evolving world of
              technology.
            </p>
          </div>
